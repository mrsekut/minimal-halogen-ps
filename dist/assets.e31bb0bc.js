...
(function ($PS) {
  ...
  var toggleButton = function toggleButton(isOn) {
    ...
    })])([Halogen_HTML_Core.text("The button is " + function () {
      if (isOn) {
        return "ON";
      }
  ...
  var reducer = function reducer(v) {
    return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (old) {
      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(!old);
    });
  };

  var store = Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
    return Halogen_VDom_Driver.runUI(store)(Data_Unit.unit)(body);
  }));
  exports["store"] = store;
